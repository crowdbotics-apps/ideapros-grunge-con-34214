...
## Project Structure
    ...
    ├── ideapros_grunge_con_34214  # Django project configurations
...
1. Clone this repo and `cd ideapros_grunge_con_34214`
...
2. Clone this repo and `cd ideapros_grunge_con_34214`
